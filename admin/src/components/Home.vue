    ...
    data () {
        return {
            ...
            menulist: [{
                ...
                path: 'null',
                children: [
                    { id: 1011, authName: '员工信息', path: 'meetingEmps' },
                    { id: 1012, authName: '员工历史请假信息', path: 'meetingEmpHistory' }
                ]
                },
                {
                id: 102,
                ...
                children: [
                    ...
                    { id: 1022, authName: '部门历史签到', path: 'depHistory' }
                ]
                },
                {
                id: 103,
                ...
                },
              {
                ...
                path: 'null',
                children: [
                  { id: 1031, authName: '已签到', path: 'SignedIn' },
                  { id: 1032, authName: '未签到', path: 'NotSignIn' }
                ]
              }],
            iconsObj: {
