<template>
    <div>
        ...
        <el-breadcrumb separator-class="el-icon-arrow-right">
            ...
            <el-breadcrumb-item>部门历史请假</el-breadcrumb-item>
        </el-breadcrumb>

        <el-card>
            <!-- 头部警告区域 -->
            <el-alert show-icon :closable="false" title="注意：只有通过审批的员工才会加入到历史请假中！" type="warning"></el-alert>
            ...
            <el-tabs v-model="activeName">
                <el-tab-pane label="已请假的员工" name="done">
                    <el-table :data="DoneList" border stripe>
                        ...
                        <el-table-column label="员工ID" prop="roomNo"></el-table-column>
                        <el-table-column label="员工名字" prop="meetingSize"></el-table-column>
...
export default {
    ...
    methods: {
        async getDeptList () {
            const { data: res } = await this.$http.get('/depts')
            if (res.code !== 100) {
