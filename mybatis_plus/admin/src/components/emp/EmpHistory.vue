<template>
    <div>
        ...
        <el-breadcrumb separator-class="el-icon-arrow-right">
            ...
            <el-breadcrumb-item>员工历史请假</el-breadcrumb-item>
        </el-breadcrumb>

        <el-card>
            <!-- 头部警告区域 -->
            <el-alert show-icon :closable="false" title="注意：只有通过审批的请假才会加入到历史请假中！" type="warning"></el-alert>
            <el-select v-model="value" placeholder="请选择员工ID" @change="selectRoom(value)">
                <el-option
            ...
            <el-tabs v-model="activeName">
                <el-tab-pane label="已请假的员工" name="done">
                    <el-table :data="DoneList" border stripe>
                        <el-table-column type="index"></el-table-column>
                        <el-table-column label="部门" prop="deptName" width="85"></el-table-column>
                        <el-table-column label="名字" prop="EmpName"></el-table-column>
<!--                        <el-table-column label="参会人数" prop="meetingSize"></el-table-column>-->
                        <el-table-column label="请假原因" prop="meetingTheme"></el-table-column>
...
export default {
    ...
    methods: {
        ...
        async selectRoom (id) {
            ...
            if (resDone.code !== 100) {
                return this.$message.error('获取历史签到列表失败！')
            } else {
